...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 17 Haz 2021, 21:06:07
...
(1, 1, '978-605-106-75-82', 3, '2021-05-30', '2021-06-06', 1),
(2, 1, '978-605-220-50-82', 2, '2021-05-30', '2021-06-06', 1),
(3, 4, '978-605360-35-35', 1, '2021-05-30', '2021-06-06', 1),
(4, 4, '978-605-8301-12-2', 1, '2021-05-30', '2021-06-06', 1),
(5, 8, '978-975-0803-376', 1, '2021-06-17', '2021-07-01', 0),
(6, 8, '978-605-3650-690', 1, '2021-06-17', '2021-07-01', 0),
(7, 8, '978-605-106-75-82', 1, '2021-06-17', '2021-07-01', 1),
(8, 8, '978-975-104-17-53', 3, '2021-06-17', '2021-07-01', 0),
(9, 8, '978-605-375-60-64', 2, '2021-06-17', '2021-07-01', 0),
(10, 9, '978-605-220-50-82', 1, '2021-06-17', '2021-07-01', 1);
...
('978-605-106-75-82', 'ZAMANIN KISA TARİHİ', '2020-12-13', 'Alfa yayınları', 0),
('978-605-220-50-82', '21. YÜZYIL İÇİN 21 DERS', '2018-09-01', 'Kollektif kitap', 0),
...
('978-605-3650-690', 'KÜÇÜK PRENS', '2017-12-01', 'Can cocuk yayınları', 0),
('978-605-375-60-64', 'WATCHMEN', '2019-05-13', 'ithaki yayınları', 0),
...
('978-975-0803-376', 'BÜYÜK SAAT', '2020-12-10', 'Yapı kredi yayınları', 0),
...
('978-975-104-17-53', 'YERALTI ÖYKÜLERİ', '2021-04-19', 'İnkılap kitabevi', 0),
...
('9786050927658', 'Mesnevi', '2017-06-15', 'Doğan Kitap', 10),
('9786052361450', 'Ikigai', '2017-06-15', 'İndigo Kitap', 10),
('9786052954027', 'Kendime Düşünceler', '2019-06-11', 'İş Bankası Kültür Yayınları', 10),
('9786053607021', 'Sokrates\'in Savunması', '2013-06-16', 'İş Bankası Kültür Yayınları', 10),
('9786054188970', 'Fedailerin Kalesi Alamut', '2009-04-16', 'Koridor Yayıncılık ', 10),
('9786054729692', 'Beyin Senin Hikayen', '1999-09-01', 'Domingo Yayınevi', 10),
('9786055029630', 'Homo Deus', '2012-05-30', 'Kolektif Kitap Yayınevi', 10),
('9786055888589', '50 Soruda Yapay Zeka', '2011-06-30', 'BİLİM VE GELECEK KİTAPLIĞI', 5),
('9786056949500', 'Bilinçaltının Gücü', '2009-04-16', 'Diyojen Yayıncılık', 10),
('9786059141239', 'Tokyo Gul ', '1998-01-01', 'Gerekli Şeyler Yayınevi', 10),
('9786059155014', 'Batman-Öldüren Şaka', '2008-06-09', 'JBC Yayıncılık', 5),
('9786059304450', 'Bir Başka Din Tasavvuf', '1998-01-01', 'Düşün Yayınları', 10),
('9786059520195', 'Kahramanlık Akademim', '2017-06-15', 'Gerekli Şeyler Yayınevi', 10),
('9786059604741', 'Çizgili Pijamalı Çocuk', '2011-06-24', 'Tudem Yayınları', 5),
('9786059851558', 'Ted Gibi Konuş', '2011-06-24', 'Aganta Kitap', 10),
('9789750738609', 'Şeker Portakalı', '2001-06-03', 'Can Çocuk Yayınları ', 10),
('9789750802959', 'Harry Potter ve Sırlar Odası', '2005-04-09', 'Yapı Kredi Yayınları', 5),
('9789750814907', 'Çiçek Senfonisi', '2008-06-09', 'Yapı Kredi Yayınları', 10),
('9789752477049', 'Dervişin Teselli Koleksiyonu', '2001-06-09', 'Hayykitap', 5),
('9789752891456', 'Uçurtma Avcısı', '2004-06-10', 'Everest Yayınları', 10),
('9789754584141', 'Ben Sana Mecburum', '2017-06-15', 'İş Bankası Kültür Yayınları', 5),
('9789754735413', 'Yedi Güzel Adam ', '2013-06-16', 'Beyan Yayınları', 5),
('9789755109725', 'Küçük Kara Balık', '1999-01-01', 'Can Çocuk Yayınları', 5),
('9789755337555', 'Dünya Tarihi', '2019-07-11', 'İmge Kitabevi', 10),
('9789758434572', 'Sofie\'nin Dünyası', '2011-06-24', 'Pan Yayıncılık', 10);
...
(8, 'deneme', 'deneme', '55555', 'deneme', 'deneme'),
(9, 'test2', 'test', '66666', 'test', 'test');
...
(24, 'Carmine', 'Gallo'),
(25, 'Jostein', 'Gaarder'),
(26, 'Mevlana Celaleddin-i', 'Rumi'),
(27, 'Mecit Ömür', 'Öztürk'),
(28, 'Sui', 'İşida'),
(29, 'Kohei', 'Horikoşi'),
(30, 'David', 'Eagleman'),
(31, 'Vladimir', 'Bartol');
...
--
ALTER TABLE `emanet`
  MODIFY `emanet_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
