...
def kitapGecmisi(uyeID):
    ...
    kitapListeleTree.column("#3", anchor=CENTER, width=180, minwidth=100)
    kitapListeleTree.heading("#3", text="Kütüphane")

    kitapListeleTree.column("#4", anchor=CENTER, width=125, minwidth=80)
    ...
    # Wrapper 3
    kitapListeleTree = Treeview(wrapper3, column=("1", "2", "3", "4", "5"),
                                show='headings', height="7",
                                selectmode="none")
    kitapListeleTree.pack(side="left")
    kitapListeleTree.place(x=0, y=0)
